...
class OrderHistoryAdapter(
    ...
    class ViewHolderOrderHistoryRestaurant(view: View) : RecyclerView.ViewHolder(view) {
        val textViewResturantName: TextView = view.findViewById(R.id.txtViewResturantName)
        val textViewDate: TextView = view.findViewById(R.id.txtViewDate)
    ...
    override fun onCreateViewHolder(
        ...
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.order_history_recycler_view, parent, false)
