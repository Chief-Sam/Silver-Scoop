...
class CartAdapter(val context: Context, val cartItems: ArrayList<CartItems>) :
    ...
    class ViewHolderCart(view: View) : RecyclerView.ViewHolder(view) {
        val textViewOrderItem: TextView = view.findViewById(R.id.txtViewOrderItem)
        val textViewOrderItemPrice: TextView = view.findViewById(R.id.txtViewOrderItemPrice)
