...
import com.shubham.silverscoop.activity.CartActivity
...
class RestaurantMenuAdapter(
    ...
    class ViewHolderRestaurantMenu(view: View) : RecyclerView.ViewHolder(view) {
        val textViewSerialNumber: TextView = view.findViewById(R.id.txtViewSerialNumber)
        val textViewItemName: TextView = view.findViewById(R.id.txtViewItemName)
        val textViewItemPrice: TextView = view.findViewById(R.id.txtViewItemPrice)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolderRestaurantMenu {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.restaurant_menu_recycler_view, parent, false)
