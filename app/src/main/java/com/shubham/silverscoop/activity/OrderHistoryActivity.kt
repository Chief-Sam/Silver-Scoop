...
import com.shubham.silverscoop.adapter.OrderHistoryAdapter
import com.shubham.silverscoop.models.OrderHistoryRestaurant
...
class OrderHistoryActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        order_activity_history_Progressdialog = findViewById(R.id.order_history_Progress_dialog)
    ...
    fun setItemsForEachRestaurant() {
        ...
        if (ConnectionManager().checkConnectivity(this)) {
            ...
            try {
                ...
                val url =
                    "http://" + getString(R.string.ip_address) + "/v2/orders/fetch_result?userId=" + user_id
