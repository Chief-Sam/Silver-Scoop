package com.shubham.silverscoop.activity
...
import com.shubham.silverscoop.fragments.DashboardFragment
import com.shubham.silverscoop.fragments.FaqsFragment
import com.shubham.silverscoop.fragments.FavouriteRestaurantFragment
import com.shubham.silverscoop.fragments.ProfileFragment
...
class Dashboard : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        textViewcurrentUser = headerView.findViewById(R.id.txtViewcurrentUser)
        textViewMobileNumber = headerView.findViewById(R.id.txtViewMobileNumber)
        ...
        //set user details
        textViewcurrentUser.text = sharedPreferencess.getString("name", "Shubham Chauhan")
        textViewMobileNumber.text =
            "+91-" + sharedPreferencess.getString("mobile_number", "9876543210")
        ...
        navigationView.setNavigationItemSelectedListener {
            ...
            previousMenuItemSelected =
                it//the current fragment will be previous fragment when a user clicks a new fragment
            ...
            when (it.itemId) {//it holds the id of the currently selected item
                ...
                R.id.myProfile -> {
                    ...
                    supportActionBar?.title =
                        "My Profile"//change the title when each new fragment is opened
                ...
                R.id.faqs -> {
                    ...
                    supportActionBar?.title =
                        "Frequently Asked Questions"//change the title when each new fragment is opened
