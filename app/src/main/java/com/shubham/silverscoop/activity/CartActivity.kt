...
import com.shubham.silverscoop.adapter.CartAdapter
import com.shubham.silverscoop.models.CartItems
import com.shubham.silverscoop.utils.ConnectionManager
...
class CartActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        textViewOrderingFrom = findViewById(R.id.txtViewOrderingFrom)
        linearLayout = findViewById(R.id.linearLayout)
        toolbar = findViewById(R.id.toolBar)
        activity_cart_Progressdialog = findViewById(R.id.activity_cart_Progress_dialog)
    ...
    fun fetchData() {
        ...
        if (ConnectionManager().checkConnectivity(this)) {
            ...
            try {
                ...
                val url =
                    "http://" + getString(R.string.ip_address) + "/v2/restaurants/fetch_result/fetch_with_restaurant_id?restaurantId=" + restaurantId
    ...
    fun createNotification() {
        ...
        notificationBulider.setSmallIcon(R.drawable.ic_app_icon)
        notificationBulider.setContentTitle("Order Placed")
        notificationBulider.setContentText("Your order has been placed Successfully")
        notificationBulider.setStyle(
            NotificationCompat.BigTextStyle()
                .bigText("Ordered placed from " + restaurantName + " and Total Amount is Rs." + totalAmount)
        )
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O)//less than oreo
        {
            ...
            val description = "Your order has been placed Successfully"
