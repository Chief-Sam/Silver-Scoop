...
import com.shubham.silverscoop.adapter.DashboardFragmentAdapter
...
class DashboardFragment(val contextParam: Context) : Fragment() {
    ...
    override fun onCreateView(
        ...
        dashboard_fragment_Progressdialog =
            view.findViewById(R.id.dashboard_fragment_Progress_dialog)
    ...
    fun fetchData() {
        ...
        if (ConnectionManager().checkConnectivity(activity as Context)) {
            ...
            try {
                ...
                val url =
                    "http://" + getString(R.string.ip_address) + "/v2/restaurants/fetch_result_all"
