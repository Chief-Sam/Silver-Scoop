...
import com.shubham.silverscoop.activity.Dashboard
...
class RegisterFragment(val contextParam: Context) : Fragment() {
    ...
    override fun onCreateView(
        ...
        buttonRegister = view.findViewById(R.id.btnSubmit)
    ...
    fun setToolBar() {
        ...
        (activity as AppCompatActivity).supportActionBar?.setHomeAsUpIndicator(R.drawable.ic_arrow_back)//change icon to custom
    }
